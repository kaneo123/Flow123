...
/// Modern, neutral color palette for light mode - EPOS Theme
class LightModeColors {
  // Primary: Emerald green for success/checkout actions
  ...
  // Secondary: Slate blue for neutral actions
  ...
  // Surface and background: Clean cream/white for EPOS
...
/// Dark mode colors with good contrast - EPOS Theme
class DarkModeColors {
  // Primary: Emerald green adjusted for dark mode
  static const darkPrimary = Color(0xFF34D399);
  static const darkOnPrimary = Color(0xFF065F46);
  ...
  // Surface and background: Dark charcoal for EPOS
